...
public class Task06
{
	...
	public static void main(String args[])
	{
		...
		Property fullName = model.createProperty(ns+ "fullName");
		Property given = model.createProperty(ns+ "given");
		Property familyName = model.createProperty(ns+ "familyName");
		JaneSmith.addLiteral(fullName , "Jane Smith");
		JaneSmith.addLiteral(given, "Jane");
		JaneSmith.addLiteral(familyName, "Smith");
